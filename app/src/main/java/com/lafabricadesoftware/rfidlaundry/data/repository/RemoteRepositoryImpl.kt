...
class RemoteRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAntenasPuestos(idPuesto: Int): List<MovMostrarAntenasPuesto> {
        return collector.getAntenasPuestos(idPuesto)
    }
