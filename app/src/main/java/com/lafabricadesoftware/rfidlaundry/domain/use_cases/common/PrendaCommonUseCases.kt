...
class PrendaCommonUseCases(
    val getPrendasCommon: GetPrendasCommon,
    val getPrendaByTagCommon: GetPrendaByTagCommon,
    val getPrendaClienteSubClienteByTagCommon: GetPrendaClienteSubClienteByTagCommon,
    val setMovPrenCommon: SetMovPrenCommon,
    val syncPendingMovimientosCommon: SyncPendingMovimientosCommon
)